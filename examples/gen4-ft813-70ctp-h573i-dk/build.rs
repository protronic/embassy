...
fn main() {
    ...
    // (Rust-Port von CANbossTouch tools/eds2lvgl.py).
    generate_canboss_tables(&manifest_dir);
...
fn generate_canboss_tables(manifest_dir: &Path) {
    let eds_dir = manifest_dir.join("eds");

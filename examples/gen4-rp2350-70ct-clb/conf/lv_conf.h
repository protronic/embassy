/**
 * @file lv_conf.h
 * Configuration file for LVGL v9.5.0 — gen4-RP2350-70CT-CLB OxivGL demo.
 * RGB565, software renderer, builtin allocator (no libc).
 */
...
/* Embedded (no libc): LVGL built-in allocator + oxivgl-sys string shims */

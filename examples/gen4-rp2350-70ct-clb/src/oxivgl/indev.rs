//! Capacitive touch input (FT5446) for OxivGL on the gen4-RP2350-70CT-CLB.
//!
...
use oxivgl_sys::{
    ...
    lv_indev_get_read_cb, lv_indev_get_read_timer, lv_indev_mode_t_LV_INDEV_MODE_EVENT, lv_indev_read,
    lv_indev_set_display, lv_indev_set_mode, lv_indev_set_read_cb, lv_indev_set_type,
    lv_indev_state_t_LV_INDEV_STATE_PRESSED, lv_indev_state_t_LV_INDEV_STATE_RELEASED, lv_indev_t,
    lv_indev_type_t_LV_INDEV_TYPE_POINTER, lv_timer_pause,
};
...
impl TouchInput {
    /// Create the LVGL pointer indev and bind it to the PSRAM display.
    ///
